...
function Home() {
  ...
  const dreamCompanies = [
     'Deloitte', 'TCS', 'IBM', 'Samsung', 'Tata Consultancy Services',
    'Landys Gear', 'Hexaware', 'Samsung SDS', 'Western Union',
    'Comviva', 'Hexaview', 'VasyErp', 'Josh Tech', 'Oracle', 'GlobalLogic'
  ];
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-blue-50 rounded-lg shadow p-6 mb-6 border-l-4 border-blue-600">
        ...
        <div className="space-y-4 mb-6">
          ...
          <p className="text-gray-800">
            We are <span className="font-bold text-blue-900"></span>, Training & Placement Representative (2024-26). 
          ...
          <ul className="space-y-2 text-gray-700">
            ...
            <li>• <span className="font-semibold">Past Recruiters:</span> Samsung SDS, IBM, TCS, Comviva, Hexaview, Western Union, GlobalLogic,Acceldata, Josh Tech</li>
          </ul>

          <div className="text-center my-6">
  <a
    href="https://drive.google.com/file/d/1_7EJt4Lo4jSeCvOvTCMUP_ZR5VxINqjn/view?usp=sharing"
    target="_blank"
  ...
  >
    <button className="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors inline-flex items-center gap-2">
      ...
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        <h2 className="text-xl font-bold text-gray-800 mb-4 text-center">Top -Placement Highlights MCA Students</h2>
      ...
      {/* Dream Companies */}
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        <h2 className="text-xl font-bold text-gray-800 mb-4 text-center">Our Past Recruiter</h2>
      ...
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-purple-50 rounded-lg p-4">
            <h3 className="font-bold text-gray-900 mb-1">Industry Ready Developer</h3>
            <p className="text-sm text-gray-600">Srudents have real world experience in development</p>
          </div>
        </div>
      </div>
